...
namespace AS.Core.Helpers
{
    public static class FileHelper
    {
        ...
        public static string _uploadBaseUrl = "F:/document/ime/";
        public static string _getBaseUrl = "https://document.dpu.edu.tr/";
        ...
        public static void SaveFile(Stream stream, string fullUrl)
        {
            using (stream)
            {
                fullUrl = _uploadBaseUrl + fullUrl;
                _byte = new byte[stream.Length];
                using (_fileStream = File.Create(fullUrl))
                {
        ...
        /// <summary>
        ///  Base64 halindeki fotografı byte[]'a çevirmek için kullanılır. Eğer string bir base64 değilse FormatException verir.
        /// </summary>
        public static byte[] ByteFromBase64(this string str) => Convert.FromBase64String(str);

        public static Stream ByteToStream(this byte[] myByte) => new MemoryStream(myByte);
        ...
        public static String CreatedNewFolder(string targetFolderPath)
        {
            targetFolderPath = _uploadBaseUrl + targetFolderPath;
            if (!Directory.Exists(targetFolderPath))
            {
                Directory.CreateDirectory(targetFolderPath);
        ...
        public static string GetMimeTypeByBase64(string base64)
        {

            var base64first = base64.Split(',')[0].Split(";")[0];
            var mimiType = base64first.Split(":")[1];
